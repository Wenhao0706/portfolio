...
This project is indexed by GitNexus as **portfolio** (571 symbols, 787 relationships, 10 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
