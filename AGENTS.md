...
This project is indexed by GitNexus as **portfolio** (619 symbols, 877 relationships, 16 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
