...
This project is indexed by GitNexus as **portfolio** (72 symbols, 74 relationships, 1 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
