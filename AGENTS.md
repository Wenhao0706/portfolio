...
This project is indexed by GitNexus as **portfolio** (665 symbols, 1006 relationships, 21 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
